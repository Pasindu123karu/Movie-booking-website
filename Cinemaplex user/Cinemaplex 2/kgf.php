...
<body>
    ...
    <header>
        <video src="./video/KGF Chapter 2 Trailer _ Tamil _Yash_Sanjay Dutt_Raveena_Srinidhi_Prashanth Neel_Vijay Kiragandur.mp4" autoplay muted ></video>
        <nav>
            <div class="logo_ul">
            <a href="./index.php">
        ...
        <div class="content">
            <h1 id="title">K.G.F 2</h1>
            <p>KGF is an Indian period action film series set mostly in the Kolar Gold Fields, which gives the series its name, created by Prashanth Neel and produced by Hombale Films starring Yash in lead role with an ensemble supporting cast.</p>
            <div class="details">
                <h6>Sony Original Film</h6>
                <h5 id="gen">Action</h5>
                <h4 id="date">2022</h4>
                <h3 id="rate"><span>IMDB</span><i class="bi bi-star-fill"></i> 8.2</h3>
            </div>
            <div class="btns">
                <a href="https://www.youtube.com/watch?v=tLeTx5OdjZs&t=60s" target="_blank" id="play">Watch Trailer<i class="bi bi-play-fill"></i></a>
