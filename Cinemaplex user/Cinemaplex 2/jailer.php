...
<head>
    ...
    <title>Jailer | Cinema Plex</title>
</head>
...
<body>
    ...
    <header>
        <video src="./video/JAILER - Release Date Announcement _ Superstar Rajinikanth _ Sun Pictures _ Nelson _ Anirudh.mp4" autoplay muted ></video>
        <nav>
            <div class="logo_ul">
            <a href="./index.php">
        ...
        <div class="content">
            <h1 id="title">Jailer</h1>
            <p>Muthuvel Pandian, a stern yet compassionate jailer, sets out to stop a gang when they try to flee their leader from prison.</p>
            <div class="details">
                <h6>Sun Pictures Original Film</h6>
                <h5 id="gen">Action</h5>
                <h4 id="date">2022</h4>
                <h3 id="rate"><span>IMDB</span><i class="bi bi-star-fill"></i> 7.1</h3>
            </div>
            <div class="btns">
                <a href="https://www.youtube.com/watch?v=1iPCrcZV6Os" target="_blank" id="play">Watch Trailer<i class="bi bi-play-fill"></i></a>
