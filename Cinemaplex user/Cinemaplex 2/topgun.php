...
<head>
    ...
    <title>Top Gun | Cinema Plex</title>
</head>
...
<body>
    ...
    <header>
        <video src="./video/Skydance _ Top Gun_ Maverick _ New Official Trailer (2022).mp4" autoplay muted ></video>
        <nav>
            <div class="logo_ul">
            <a href="./index.php">
        ...
        <div class="content">
            <h1 id="title">Top Gun</h1>
            <p> Training a detachment of graduates for a special assignment, Maverick must confront the ghosts of his past and his deepest fears, culminating in a mission that demands the ultimate sacrifice from those who choose to fly it. </p>
            <div class="details">
            ...
            <div class="btns">
                <a href="https://www.youtube.com/watch?v=giXco2jaZ_4" target="_blank" id="play">Watch Trailer<i class="bi bi-play-fill"></i></a>
