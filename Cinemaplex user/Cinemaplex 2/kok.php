...
<head>
    ...
    <title>King Of Kotha | Cinema Plex</title>
</head>
...
<body>
    ...
    <header>
        <video src="./video/King of Kotha Tamil Trailer _ Dulquer Salmaan _ Abhilash Joshiy _ Jakes Bejoy _ August 24th.mp4" autoplay muted ></video>
        <nav>
            <div class="logo_ul">
            <a href="./index.php">
        ...
        <div class="content">
            <h1 id="title">King Of Kotha</h1>
            <p>Ravi's son Tony is torn between his inherited legacy and his desire for a different life. Unlike his father, Tony isn't drawn to the dark world of crime. Instead, he falls in love with a woman from a wealthy background.</p>
            <div class="details">
                <h6>Zee Studios Original Film</h6>
                <h5 id="gen">Action</h5>
                <h4 id="date">2022</h4>
                <h3 id="rate"><span>IMDB</span><i class="bi bi-star-fill"></i> 6.1</h3>
            </div>
            <div class="btns">
                <a href="https://www.youtube.com/watch?v=fEuJ9s4yk3w&t=33s" target="_blank" id="play">Watch Trailer<i class="bi bi-play-fill"></i></a>
