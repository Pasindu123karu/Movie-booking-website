...
<body>
    ...
    <header>
        <video src="./video/JAWAN Trailer 2023.mp4" autoplay muted></video>
        <nav>
            <div class="logo_ul">
            <a href="./index.php">
        ...
        <div class="content">
            ...
            <p>A man is driven by a personal vendetta to rectify the wrongs in society, while keeping a promise made years ago. He comes up against a monstrous outlaw with no fear, who has caused extreme suffering to many.</p>
            <div class="details">
            ...
            <div class="btns">
                ...
                <a href="https://www.youtube.com/watch?v=COv52Qyctws" target="_blank" id="play">Watch Trailer<i class="bi bi-play-fill"></i></a>
