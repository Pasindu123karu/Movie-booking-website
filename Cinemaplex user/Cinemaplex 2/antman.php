...
<head>
    ...
    <title>Ant Man | Cinema Plex</title>
</head>
...
<body>
    ...
    <header>
        <video src="./video/Marvel Studios’ Ant-Man and The Wasp_ Quantumania _ New Tamil Trailer.mp4" autoplay muted ></video>
        <nav>
            <div class="logo_ul">
            <a href="./index.php">
        ...
        <div class="content">
            ...
            <div class="details">
                <h6>Walt Disney Studios Original Film</h6>
                <h5 id="gen">Action</h5>
                <h4 id="date">2023</h4>
                <h3 id="rate"><span>IMDB</span><i class="bi bi-star-fill"></i> 6.1</h3>
            </div>
            <div class="btns">
                <a href="https://www.youtube.com/watch?v=ZlNFpri-Y40" target="_blank" id="play">Watch Trailer<i class="bi bi-play-fill"></i></a>
