...
<head>
    ...
    <title>Avengers | Cinema Plex</title>
</head>
...
<body>
    ...
    <header>
        <video src="./video/Marvel Studios' Avengers_ Endgame - Official Trailer.mp4" autoplay muted ></video>
        <nav>
            <div class="logo_ul">
            <a href="./index.php">
        ...
        <div class="content">
            ...
            <div class="btns">
                <a href="https://www.youtube.com/watch?v=6ZfuNTqbHE8" target="_blank" id="play">Watch Trailer<i class="bi bi-play-fill"></i></a>
