...
<body>
    ...
    <header>
        <video src="./video/Eesho Official Teaser _ Jayasurya _ Nadirshah _ Namitha Pramod.mp4" autoplay muted ></video>
        <nav>
            <div class="logo_ul">
            <a href="./index.php">
        ...
        <div class="content">
            <h1 id="title">Eesho</h1>
            <p>Eesho is an Indian Malayalam-language drama thriller film film directed by Nadirshah featuring Jayasurya and Namitha Pramod in the lead roles. The film written by Suneesh Varanad is produced by Arun Narayan.</p>
            <div class="details">
            ...
            <div class="btns">
                <a href="https://www.youtube.com/watch?v=zGQVlv1V5gY" target="_blank" id="play">Watch Trailer<i class="bi bi-play-fill"></i></a>
