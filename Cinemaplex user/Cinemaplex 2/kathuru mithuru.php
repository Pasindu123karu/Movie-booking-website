...
<head>
    ...
    <title>Kathuru Mithuru | Cinema Plex</title>
</head>
...
<body>
    ...
    <header>
        <video src="./video/katuru mituru.mp4" autoplay muted ></video>
        <nav>
            <div class="logo_ul">
            <a href="./index.php">
        ...
        <div class="content">
            <h1 id="title">Kathuru Mithuru</h1>
            <p>Kathuru Mithuru is a 2023 Sri Lankan Sinhala comedy film directed by Giriraj Kaushalya and produced by Basuru Siriwardena for Alankulama Films. The film stars Jayalath Manoratne and Mahendra Perera in lead role .</p>
            <div class="details">
            ...
            <div class="btns">
                <a href="https://www.youtube.com/embed/eXfk7hTsmGQ?si=p2G4ExErguIlzkA2" target="_blank" id="play">Watch Trailer<i class="bi bi-play-fill"></i></a>
