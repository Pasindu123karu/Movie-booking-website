...
<head>
    ...
    <title>College Romance | Cinema Plex</title>
</head>
...
<body>
    ...
    <header>
        <video src="./video/College Romance S4 _ Gagan Arora, Apoorva Arora, Shreya Mehta, Keshav Sadhna, Nupur Nagpal.mp4" autoplay muted ></video>
        <nav>
            <div class="logo_ul">
            <a href="./index.php">
        ...
        <div class="content">
            <h1 id="title">College Romance</h1>
            <p>Three best friends look for love, laughs and some lifelong memories while attending college together.</p>
            <div class="details">
                <h6>Sony Pictures Original Film</h6>
                <h5 id="gen">Romance</h5>
                <h4 id="date">2023</h4>
                <h3 id="rate"><span>IMDB</span><i class="bi bi-star-fill"></i>8.3</h3>
            </div>
            <div class="btns">
                <a href="https://www.youtube.com/watch?v=Gl4dCLllcO4" target="_blank" id="play">Watch Trailer<i class="bi bi-play-fill"></i></a>
